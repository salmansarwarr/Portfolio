...
import { reactjs, nextjs, solidity, javascript, typescript } from '../../images/extra-pics';
                            ...
                            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                                ...
                                <div className={`relative px-4 py-16 sm:px-6 sm:py-24 lg:py-24 lg:px-8 ${screen370 && `ml-2`}`}>
                                    <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl cursor-default myHoverEffect4">
                                        <Zoom duration={1300}><span className="block text-white tracking-wide selection:bg-transparent" style={{ wordSpacing: "0.105rem" }}>{!screen260 && `Muhammad`} Salman Sarwar</span></Zoom>
                                            ...
                                            {  //above 450
                                                !screen450 && (
                                                    <>
                                                        ...
                                                        <h6 className="cursor-pointer selection:bg-transparent p-3"> <b>|</b> </h6>
                                                        <h4 className="cursor-pointer selection:bg-transparent shadow-xl shadow-red-800 myHoverEffect1"> <span className="badge bg-danger text-white p-4"> Blockchain Developer </span> </h4>
                                                    </>
                                                )
                                            }
                                            {  //below 450 & above 400
                        ...
                        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                            ...
                            <div className={`${screen700 ? `mt-16` : `mt-14`} flex align-middle justify-around`}>
                                ...
                                <div className={`mt-3 cursor-pointer myHoverEffect3 ${screen1100 && `hidden`} selection:bg-transparent`}>
                                    <Zoom duration={1300}>
                                        <Image width="260rem" height="94.025rem" src={solidity} />
                                    </Zoom>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <LightSpeed duration={1300}>
                                            <div className={`${!screen863 && `flex align-middle justify-center`}`}>
                                                <footer className="mt-10">
                                                    <p className={`text-base font-medium selection:bg-transparent ${screen400 ? `text-black` : `text-white`} tracking-wider cursor-pointer`} style={{ margin: !screen863 ? "0 auto" : "", marginBottom: !screen863 ? "1.05rem" : "0.95rem" }}>Muhammad Salman Sarwar</p>
                                                    <p className={`text-sm font-medium  ${screen400 ? `text-gray-700` : `text-indigo-100`} tracking-wide -mt-4 italic`}>Software Engineer, NED University of Engineering And Technology</p>
                                                </footer>
                                            </div>
                                        </LightSpeed>
                                    </blockquote>
                    ...
                    <div className={`${!screen300 && `bg-black`} border-t border-gray-200 pt-8 pb-4 flex items-center align-middle justify-center flex-col lg:mt-16`}>
                        <Slide duration={1300} left>
                            <div className="flex space-x-6 md:order-2 align-middle">
                                ...
                                <a className="cursor-pointer text-gray-400 hover:text-gray-500 myHoverEffect1"
                                    target="_blank" href="https://www.github.com/salmansarwarr"
                                >
                                    <GitHubIcon fontSize="large" />
                                </a>
                                <a className="cursor-pointer text-gray-400 hover:text-gray-500 myHoverEffect1"
                                    target="_blank" href="https://www.linkedin.com/in/-salmansarwar/"
                                >
                        ...
                        <Slide duration={1300} right>
                            <p className={`mt-8 text-base md:mt-0 md:order-1 ${screen300 && `hidden`}`}>
                                ...
                                <a href="#" className="text-gray-400 hover:text-gray-400 select-none"> <span style={{ fontFamily: "serif !important" }} className="font-bold">+923150259301</span> ( WhatsApp ) </a>
                            </p>
                        </Slide>
                    </div>
                </footer>
